            ...
            <div class="card mt-2 mx-auto p-4 bg-light">
                ...
                <div class="card-body bg-light">
                    ...
                    <div class="container">
                        ...
                        <form id="contact-form" method="POST" action="request-controller.php">
                            <div class="controls">
                                <div class="row">
                                    <div class="col-md-6">
									...
									<div class="form-group"> <label for="form_lastname"> Categorie</label> <input id="form_lastname" type="text" name="category" class="form-control" placeholder="Si autre catégorie ..."  data-error="Lastname is required."> </div>
                                    </div>
