...
<?=display_navbar_user()?>
    ...
    <div class='container'>
        <div class="form col-md">
             <span><a href="request.php"><button class="btn btn-light btn-block back" ><b>+</b> </button></a> </span> 
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST">
            
                <input class="form-control" type="search" placeholder="Votre recherche" name="query" maxlength="auto" size="50" id="query">
